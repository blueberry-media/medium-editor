...
(function () {
    ...
    var Toolbar = MediumEditor.Extension.extend({
        ...
        positionToolbar: function (selection) {
            ...
            var range = selection.getRangeAt(0),
            //var range = $('.selected-active')[0],// Always display the toolbar above the selected element. was: range = selection.getRangeAt(0) // MAGLR
    ...
    function handleKeyup(event) {
        ...
        if (MediumEditor.util.isKey(event, MediumEditor.util.keyCode.ENTER) && !MediumEditor.util.isListItem(node)) {
            ...
            if (tagName === 'a') {
                ...
                if (!/h\d/.test(tagName)) {
                    this.options.ownerDocument.execCommand('formatBlock', false, null);
                }
            }
        }
    }
